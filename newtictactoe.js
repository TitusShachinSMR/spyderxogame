...
const numElements = 100; // Adjust the number of X's and O's
// just for creating the x- o pattern which changes duiring every refresh , for creating x-o space effect
for (let i = 0; i < numElements; i++) {
  ...
  const size = Math.random() * 20; // Random size between 20px and 70px
  ...
  const x = Math.random() * 100; // Percentage from 0 to 100
  const y = Math.random() * 100; // Percentage from 0 to 100
